...
public class WWNStreamingRestClient {
    ...
    public WWNStreamingRestClient(String accessToken, WWNRedirectUrlSupplier redirectUrlSupplier,
    ...
    private EventSource createEventSource() throws FailedResolvingWWNUrlException {
        SSLContext sslContext = SslConfigurator.newInstance().createSSLContext();
        Client client = ClientBuilder.newBuilder().sslContext(sslContext).register(SseFeature.class)
                .register(new WWNStreamingRequestFilter(accessToken)).build();
