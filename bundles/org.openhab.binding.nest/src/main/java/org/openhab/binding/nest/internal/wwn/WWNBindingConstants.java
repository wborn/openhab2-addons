...
public class WWNBindingConstants {
    ...
    public static final Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Stream.of(THING_TYPE_ACCOUNT, THING_TYPE_CAMERA,
            THING_TYPE_SMOKE_DETECTOR, THING_TYPE_STRUCTURE, THING_TYPE_THERMOSTAT).collect(Collectors.toSet());
