...
public class SDMBindingConstants {
    ...
    public static final Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Stream
            .of(THING_TYPE_ACCOUNT, THING_TYPE_CAMERA, THING_TYPE_DISPLAY, THING_TYPE_DOORBELL, THING_TYPE_THERMOSTAT)
            .collect(Collectors.toSet());

    // Maps SDM device types to Thing Types UIDs
    public static final Map<SDMDeviceType, ThingTypeUID> SDM_THING_TYPE_MAPPING = createThingTypeMap();

    private static Map<SDMDeviceType, ThingTypeUID> createThingTypeMap() {
        Map<SDMDeviceType, ThingTypeUID> map = new HashMap<>();
        map.put(SDMDeviceType.CAMERA, THING_TYPE_CAMERA);
        map.put(SDMDeviceType.DISPLAY, THING_TYPE_DISPLAY);
        map.put(SDMDeviceType.DOORBELL, THING_TYPE_DOORBELL);
        map.put(SDMDeviceType.THERMOSTAT, THING_TYPE_THERMOSTAT);
        return map;
    }
