...
public class SDMResourceNameTest {
    ...
    public void nameless() {
        ...
        assertThat(resourceName.name, isEmptyString());
        assertThat(resourceName.projectId, isEmptyString());
        assertThat(resourceName.deviceId, isEmptyString());
        assertThat(resourceName.structureId, isEmptyString());
        assertThat(resourceName.roomId, isEmptyString());
