...
public class SDMDeviceTest {
    ...
    public void deserializeThermostatDevice() throws IOException {
        ...
        assertThat(thermostatMode.availableModes, is(Arrays.asList(SDMThermostatMode.HEAT, SDMThermostatMode.OFF)));
        ...
        assertThat(thermostatEco.availableModes,
                is(Arrays.asList(SDMThermostatEcoMode.OFF, SDMThermostatEcoMode.MANUAL_ECO)));
    ...
    public void deserializeCameraDevice() throws IOException {
        ...
        assertThat(cameraLiveStream.videoCodecs, is(Arrays.asList("H264")));
        assertThat(cameraLiveStream.audioCodecs, is(Arrays.asList("AAC")));
