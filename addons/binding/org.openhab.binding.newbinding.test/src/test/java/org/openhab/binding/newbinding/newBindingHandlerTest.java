...
/**
 * Test cases for {@link newBindingHandler}. The tests provide mocks for supporting entities using Mockito.
 *
 * @author Wouter Born - Initial contribution
 */
public class newBindingHandlerTest extends JavaTest {
    ...
    public void setUp() {
        initMocks(this);
        handler = new newBindingHandler(thing);
